    ...
    <section
      ...
      <div
        ...
        <div
          ...
          <button
            onClick={handleClose}
            className={` bg-gris_fondo dark:bg-dark_fondo text-black text-[1em] px-6 py-2 rounded-md shadow-sm shadow-black hover:shadow-md hover:shadow-black active:shadow-inner active:shadow-black`}>
            Cerrar
          </button>
          <button
