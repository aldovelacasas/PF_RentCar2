...
function AboutPage() {
  return (
    <div className="grid bg-gris_frente ">
      ...
      <section
        className={`pt-4 ${poppins} mx-[auto] max-w-[450px] text-[0.8em] bg-gris_frente pb-10`}>
        <p className={`text-[0.8rem] ${rubik} text-center`}>¿Quiénes somos?</p>
        <p className={`text-[1rem] ${rubik} text-center`}>Rent-A-Car</p>
        <p className="pt-4 mb-2 px-8">
        ...
        <div className="flex items-baseline">
          <div className="w-full flex flex-col justify-center items-center gap-x-4  px-3">
            ...
            <p className={`text-[1.2rem] ${rubik}`}>80</p>
          ...
          <div className="w-full flex flex-col justify-center items-center gap-x-4  px-3 my-10">
            ...
            <p className={`text-[1.2rem] ${rubik}`}>+500</p>
            <p className={`text-[0.8rem] ${rubik} mb-2 text-center`}>
              Rentas exitosas
            </p>
          </div>
          <div className="w-full flex flex-col justify-center items-center gap-x-4  px-3">
            ...
            <p className={`text-[1.2rem] ${rubik}`}>7</p>
            <p className={`text-[0.8rem] ${rubik} mb-2 text-center`}>
              Puntos de servicio
            </p>
          </div>
      ...
      <section className="p-4 pb-[90px] max-w-[450px] justify-self-center">
        ...
        <div className="grid grid-cols-2 gap-[15px]">
          {aboutUs.map((i) => {
            return (
              <figure
                key={i.nombre}
                className="rounded-md p-2 shadow-md shadow-black bg-white">
                <img
                  src={i.imagen}
                ...
                <div className="flex justify-between py-2 px-2">
                  <a href={i.linkedIn} target="_blank">
                    <img
                      ...
                      alt="linkedin logo"
                      width="50"
                      className="shadow-sm shadow-black rounded-md hover:shadow-md hover:shadow-black"
                    />
                  </a>
                  <a href={i.github} target="_blank">
                    <img
                      ...
                      alt="github logo"
                      width="50"
                      className="shadow-sm shadow-black rounded-full hover:shadow-md hover:shadow-black"
                    />
                  </a>
                </div>
              </figure>
