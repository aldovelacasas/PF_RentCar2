...
function AboutPage() {
  return (
    <div className="grid bg-gris_frente min-[400px]:text-[1.5em]">
      <header
      ...
      <section
        className={`pt-4 ${poppins} mx-[auto] w-3/4 text-[0.8em] bg-gris_frente pb-10 min-[400px]:text-[1.5em]`}>
      ...
      <section className="p-4 pb-[90px] grid justify-self-center">
        <p
          className={`text-[1em] ${rubik} mb-6 text-center min-[400px]:text-[1.5em]`}>
          Nuestro Equipo
        </p>
        <div className="grid w-4/5 place-self-center grid-cols-2 min-[600px]:grid-cols-3 min-[1150px]:grid-cols-4 gap-[15px]">
          {aboutUs.map((i) => {
            return (
              <figure
                key={i.nombre}
                ...
                <div className="flex justify-between py-2 px-2 min-[600px]:justify-around">
                  <a href={i.linkedIn} target="_blank">
                    <img
                      src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/LinkedIn_logo_initials.png/800px-LinkedIn_logo_initials.png"
                      alt="linkedin logo"
                      className="shadow-sm w-[35px] min-[600px]:w-[50px] shadow-black rounded-md hover:shadow-md hover:shadow-black"
                    />
                  </a>
                  <a href={i.github} target="_blank">
                    <img
                      ...
                      alt="github logo"
                      className="shadow-sm w-[35px] min-[600px]:w-[50px] shadow-black rounded-full hover:shadow-md hover:shadow-black"
                    />
                  </a>
                </div>
              </figure>
