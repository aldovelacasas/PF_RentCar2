...
function HomePage() {
  return (
    <>
      ...
      <form className={`pt-2 ${poppins} text-[0.8em] pl-16 bg-gris_frente`}>
        ...
        <br />
        <input className="bg-gris_fondo w-[280px]" name="fechaFin" />
        <button
          className={`bg-naranja_enf text-white text-[0.7rem] px-4 py-1 ${poppins} shadow-sm shadow-black hover:shadow-md hover:shadow-black active:shadow-inner active:shadow-black`}>
          Buscar
        </button>
      </form>
    </>
