...
function HomePage() {
  return (
    <div className={`bg-gris_fondo ${rubik} space-y-0 space-x-2.5`}>
      ...
      <p className="text-[1.3em] mb-0 pb-0 leading-5">
        <span className="text-naranja_enf mb-0 pb-0 leading-3">Ahorra </span>
        con nuestra
      </p>
      <p className="text-[1.3em] mt-0 pt-0 leading-3">renta de vehículos</p>
      <div>
