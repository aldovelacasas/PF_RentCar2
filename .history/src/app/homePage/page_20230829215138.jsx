  ...
  return (
    <>
      ...
      <section className={`pt-4 ${poppins} text-[0.8em] bg-gris_frente pb-12`}>
        ...
        <div>
          <figure className="bg-[#ea4e398a] float-left rounded-full h-[80px] w-[80px] flex justify-center items-center">
            <PiCar className="text-[50px] text-naranja_enf stroke-2" />
          </figure>
          <p className={`text-[0.8rem] ${rubik} mb-2 text-center`}Elije tu carro</p>
          <span>
