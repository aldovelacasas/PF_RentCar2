...
function HomePage() {
  return (
    <>
      ...
      <form className={`pt-2 ${poppins} text-[0.8em] bg-gris_fondo px-4 pb-12`}>
        <p className={`${rubik} text-2xl`}>Suscríbete</p>
        <p className="py-2">
          Infórmate antes que nadie de nuestras ofertas y descuentos especiales.
        </p>
        <label htmlFor="email">Email</label> <br />
        <input type="text" name="email" className="w-3/4" />
        <button className="text-white bg-naranja_enf px-4 ml-4 text-[0.8em] leading-5 shadow-sm shadow-black">
          Suscribirme
        </button>
      </form>
    </>
