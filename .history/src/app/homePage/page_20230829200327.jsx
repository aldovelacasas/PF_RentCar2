  ...
  return (
    <>
      ...
      <form className={`pt-2 ${poppins} text-[0.6em] pl-12 bg-gris_frente`}>
        ...
        <br />
        <input className="bg-gris_fondo w-[250px] mb-2" name="categoría" />{" "}
        <br />
        ...
        <br />
        <input className="bg-gris_fondo w-[250px]" name="fechaFin" /> <br />
        <label htmlFor="fechaFin" className="">
          <FaCalendarAlt className="inline text-naranja_enf mr-2" /> Fecha de
          fin
        </label>
        <br />
        <input className="bg-gris_fondo w-[250px]" name="fechaFin" />
      </form>
    </>
  );
}
