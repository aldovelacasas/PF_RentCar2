  ...
  return (
    <>
      ...
      <section className={`pt-4 ${poppins} text-[0.8em] bg-gris_frente pb-12`}>
        ...
        <div>
          <figure className="bg-[#ea4e398a] inline rounded-full h-[80px] w-[80px] flex justify-center items-center">
            <PiCar className="text-[50px] float-left text-naranja_enf stroke-2" />
          </figure>
          <span>Elije tu carro</span>
          <span>
