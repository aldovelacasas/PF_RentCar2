...
function HomePage() {
  return (
    <>
      ...
      <form className={`${poppins} text-[0.6em]`}>
        <p className={`mt-2 ml-2.5 text-[0.8rem] ${rubik} mb-2`}>
          Renta un auto
        </p>
        <label htmlFor="categoria" className="ml-2">
          <BiSolidCar className="inline text-naranja_enf" /> Elige una categoría
        </label>
        <input className="bg-gris_fondo" name="categoría" />
      </form>
    </>
  );
}
