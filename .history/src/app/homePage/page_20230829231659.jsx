  ...
  return (
    <>
      ...
      <section
        ...
        <table className="[&>*:nth-child(odd)]:bg-[#ea4e398a] bg-white px-4">
          <tr>¿Cuánto tiempo tengo para devolver el pedido?</tr>
          <tr>
            Depués de vencido tu periodo de renta, cuentas con una hora de
            tolerancia para devolver el vehículo.
          </tr>
          <tr>¿Qué pasa si olvidé algo en el interior del auto?</tr>
          <tr>
            No te preocupes, nosotros te contactaremos tan pronto realicemos la
            limpieza del vehículo para que puedas venir a recoger tus
            pertenencias.
          </tr>
          <tr>¿El vehículo cuenta con seguro?</tr>
          <tr>
            Claro que sí, todos nuestros vehículos se encuentran en buen estado
            y con todos sus papeles en orden de manera que puedes conducir sin
            preocupaciones.
          </tr>
        </table>
      </section>
