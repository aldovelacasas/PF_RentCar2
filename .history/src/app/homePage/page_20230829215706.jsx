    ...
    <>
      ...
      <section className={`pt-4 ${poppins} text-[0.8em] bg-gris_frente pb-12`}>
        ...
        <div className="w-full flex justify-center px-3">
          <figure className="bg-[#ea4e398a] basis-[80px] float-left rounded-full h-[80px] w-[80px] flex justify-center items-center">
            <PiCar className="text-[50px] text-naranja_enf stroke-2" />
          </figure>
          <div className="">
            <p className={`text-[1rem] ${rubik} mb-2`}>Elije tu carro</p>
