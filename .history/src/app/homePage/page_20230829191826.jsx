...
function HomePage() {
  return (
    <div className={`bg-gris_fondo ${rubik} space-y-0 space-x-2.5`}>
      ...
      <p className="text-[1.3em] mt-0 pt-0">renta de vehículos</p>
      <div>
        ...
        <div className="flex place-content-evenly w-3/4 mt-3 pb-4">
          <a
            href="#form"
            className={`bg-naranja_enf text-white text-[0.7em] px-4 py-1 ${poppins}`}>
            Renta
          </a>
          <a
            href="#form"
            className={`bg-negro_fondo text-white text-[0.7em] px-4 py-1 ${poppins}`}>
            Conoce más
          </a>
        </div>
      </div>
