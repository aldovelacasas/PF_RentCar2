    ...
    <div className={`bg-gris_fondo ${rubik} space-y-0 space-x-2.5`}>
      ...
      <div>
        ...
        <div className="flex place-content-evenly w-3/4 mt-3 pb-8">
          <button
            href="#form"
            className={`bg-naranja_enf text-white text-[0.7em] px-4 py-1 ${poppins} shadow-sm shadow-black hover:shadow-sm hover:shadow-gris_fondo active:shadow-inner active:shadow-black`}>
