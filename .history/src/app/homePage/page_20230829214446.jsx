  ...
  return (
    <>
      ...
      <form
        ...
        <br />
        <input className="bg-gris_fondo w-[150px] mb-4" name="categoría" />{" "}
        <br />
        ...
        <br />
        <input className="bg-gris_fondo w-[150px] mb-4" name="fechaFin" />{" "}
        <br />
        ...
        <br />
        <input className="bg-gris_fondo w-[150px]" name="fechaFin" /> <br />
        <button
