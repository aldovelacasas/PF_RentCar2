...
function HomePage() {
  return (
    <>
      ...
      <section
        className={`pt-4 ${rubik} mx-[auto] text-white text-center text-[0.8em] bg-negro_fondo pb-12`}>
        <p>Ven y ahorra con nosotros</p>
        <p>
          Contamos con atención al cliente <span>24/7</span>
        </p>
      </section>
    </>
  );
