  ...
  return (
    <>
      ...
      <form className={`pt-2 ${poppins} text-[0.6em] pl-2.5 bg-gris_frente`}>
        ...
        <br />
        <input className="bg-gris_fondo w-3/4" name="categoría" /> <br />
        <label htmlFor="fechaInicio" className="mt-2">
          <BiSolidCar className="inline text-naranja_enf mr-2" /> Fecha de
          inicio
        </label>
        <br />
