...
import { FaRegCalendarDays } from "react-icons/fa";
    ...
    <>
      ...
      <form className={`pt-2 ${poppins} text-[0.6em] pl-2.5 bg-gris_frente`}>
        ...
        <label htmlFor="fechaInicio" className="">
          <FaRegCalendarDays className="inline text-naranja_enf mr-2" /> Fecha
          de inicio
        </label>
        <br />
        <input className="bg-gris_fondo w-3/4" name="fechaInicio" />
      </form>
    </>
  );
}
